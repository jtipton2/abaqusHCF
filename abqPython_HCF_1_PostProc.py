###############################################################################
#
# File:         abaqusScript_Dynamic_v20200928.py
# Language:     PYTHON scripting for Abaqus/Viewer Release 2020.HF4
# Author:       Joseph B. Tipton, Jr.
#
# Summary:      This script opens an Abaqus/Explicit solution of a tungsten
#               element with a thermal pulse.  It operates on 
#               averaged nodal stresses.  At each timestep, it runs through each
#               node and keeps track of the static (mean), minimum, and maximum
#               stresses.  These are saved as nodal fields at the last timestep.
#               The user can then combine them into a fatigue analysis using CAE
#               for maximum flexibility.
#
# File Run:     C:\temp>abaqus python abaqusScript_Dynamic_v20200928.py
